  ...
  Widget build(BuildContext context) {
    ...
    Widget _buildFeed(Feed feed){
      switch(feed.type){
        ...
        case FeedType.event:
          return Card(child: Padding(child: Image.asset(feed.url, height: 200, fit: prefix1.BoxFit.fitWidth,), padding: EdgeInsets.fromLTRB(4.0, 4.0, 4.0, 4.0),), elevation: 20.0,
           margin: prefix0.EdgeInsets.fromLTRB(20.0, 10.0, 20.0, 10.0), shape: RoundedRectangleBorder(
...
class HeaderSponsor extends StatelessWidget{
  ...
  prefix0.Widget build(prefix0.BuildContext context) {
    return ListView(
      ...
      children: <Widget>[Image.asset("assets/images/guardian.jpg", height: 50.0, width: 30.0,),
      Image.asset("assets/images/guardian.jpg", height: 50.0, width: 30.0,),
      Image.asset("assets/images/guardian.jpg", height: 50.0, width: 30.0,),
      Image.asset("assets/images/guardian.jpg", height: 50.0, width: 30.0,),
      Image.asset("assets/images/guardian.jpg", height: 50.0, width: 30.0,)],
       shrinkWrap: true,
