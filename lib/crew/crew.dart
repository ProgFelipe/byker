...
class Crew extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      children: <Widget>[
        RiderInfo(), RiderRecords(), RiderCrew(), Container(child: MyRides(),)],
    );
  }
}
...
class MyRides extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<Feed> feeds = [
      Feed(likes: 20, shareTimes: 4, routeName: "Medellin - Filandia", fillGasTimes: 2, urlRoute: "assets/images/staticmap3.jpg", pictures: ["",""], spendTime: "4h 30m"),
      Feed(likes: 80, shareTimes: 100,routeName: "Medellin - Cocorna", urlRoute: "assets/images/staticmap2.jpg", spendTime: "7h 45m"),
      Feed(likes: 1, shareTimes: 7, routeName: "Medellin - Rio Claro", urlRoute: "assets/images/staticmap3.jpg", spendTime: "2h 30m")
    ];
